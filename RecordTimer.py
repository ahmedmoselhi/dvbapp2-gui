...
class RecordTimerEntry(timer.TimerEntry, object):
    ...
    def activate(self):
        ...
        if next_state == self.StateRunning:
            ...
            if debug:
                print '[RECORDTIMER] self.autostate=%s' % self.autostate, 'wasRecTimerWakeup=%s' % wasRecTimerWakeup, 'self.wasInStandby=%s' % self.wasInStandby, 'self.afterEvent=%s' % self.afterEvent
