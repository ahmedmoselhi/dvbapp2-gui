...
from boxbranding import getBoxType, getMachineBuild, getMachineBrand, getMachineName, getMachineProcModel, getImageVersion
...
def newsURL():
    if getImageVersion() == '7.2':
        news = 'http://egami-feed.com/plugins/egaminews72.xml'
    else:
        news = 'http://egami-feed.com/plugins/egaminews80.xml'
    return news
