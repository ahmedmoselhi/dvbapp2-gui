...
class EGAMIPluginLoadScreen(ConfigListScreen, Screen):
    ...
    def __init__(self, session, args = 0):
        ...
        self['key_green'] = Label(_('Wizard'))
        self['key_blue'] = Label(_('Reload'))
        ConfigListScreen.__init__(self, list)
        self['actions'] = ActionMap(['OkCancelActions', 'ColorActions'], {'back': self.dontSaveAndExit,
         'exit': self.dontSaveAndExit,
         'red': self.saveAndExit,
         'green': self.keyYellow,
         'blue': self.reloadNow,
    ...
    def keyYellow(self):
        ...
        self.session.open(EGAMISpeedUpWizard)
